...
long_description = 'travis related utilities'   # will be overwritten with long_description if exists !
...
setup_kwargs['description'] = 'travis related utilities'
...
setup_kwargs['entry_points'] = {'console_scripts': ['lib_travis = lib_travis.lib_travis_cli:cli_main']}
